# PR #49 paid live — Luna (`openai-gpt-5.6-luna`) — materiality rebalance tip

**When:** 2026-09-23 ~11:40–11:44 IST (Asia/Calcutta)  
...
python -m aeo_mvp.cli fixtures/agents-z2h-live.md \
  --domain nik-hil.hashnode.dev \
  --live \
  --out docs/live-luna-20260923-061008/
```
